...
var Inflector = require('../core/Inflector');
...
module.exports = {
  methods: {
    ...
    updateAttribute: function(name, value, cb) {
      var setterMethod = 'set' + Inflector.camelize(name);
    ...
    toggle: function(attribute) {
      var method = 'is' + Inflector.camelize(name);

      this._attributes[attribute] = !this[method]();
