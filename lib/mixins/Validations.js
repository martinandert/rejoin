...
module.exports = {
  ...
  singleton: {
    validates: function() {
      ...
      if (_.isPlainObject(_.last(attributes))) {
        defaults = attributes.pop();
      }

      var validations = _.omit(defaults, 'if', 'unless', 'on', 'allowBlank', 'allowNull', 'message');
    ...
    validatesWith: function() {
      ...
      if (_.isPlainObject(_.last(validators))) {
        options = validators.pop();
      }
    ...
    validatesInclusionOf: function() {
      this.validatesWith(validators.InclusionValidator, this._mergeAttributes.apply(this, sliced(arguments)));
    },

    validatesExclusionOf: function() {
      this.validatesWith(validators.ExclusionValidator, this._mergeAttributes.apply(this, sliced(arguments)));
    },

    validatesUniquenessOf: function() {
      this.validatesWith(validators.UniquenessValidator, this._mergeAttributes.apply(this, sliced(arguments)));
    }
  },
