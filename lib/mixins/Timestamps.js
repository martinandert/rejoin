...
module.exports = {
  ...
  prototype: {
    ...
    getTimestampAttributesForCreateInModel: function() {
      return this.getTimestampAttributesForCreate().filter(function(name) { return hasProp(this.constructor.attributeDefinitions, name); }, this);
    },

    getTimestampAttributesForUpdateInModel: function() {
      return this.getTimestampAttributesForUpdate().filter(function(name) { return hasProp(this.constructor.attributeDefinitions, name); }, this);
    }
  }
};
